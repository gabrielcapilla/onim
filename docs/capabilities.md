...
| LSP assistance                           | native                 | Document symbols/highlights, folding, selection ranges, signature help, semantic tokens, resolved import/include document links, workspace symbols, and known type definitions.                                              |
